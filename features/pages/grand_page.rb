...
#  @browser.link(:xpath, "//*[@id='tours-dropdown']/li[1]/a").click
#  end 


# def flight
#    @browser.link(:xpath, "//div[1]/div[1]/div[2]/div[2]/div[1]/a").click
# end

# def flight_landing
#    @browser.link(:xpath, "//div[1]/div[2]/div[2]/div[2]/a").click
# end

# def flight_skywalk
#    @browser.link(:xpath, "//div[1]/div[2]/div[2]/div[3]/a").click
# end

# def flight_voyager
#    @browser.link(:xpath, "//div[1]/div[1]/div[2]/div[2]/div[4]/a").click
# end
...
#  def date
# 	@browser.input(:xpath,"//div[1]/div[1]/div/div[6]/div[2]/div[1]/input").when_present.click
#     sleep 2
#     @browser.input(:xpath,"//div[6]/div[2]/div[1]/div/div/div/div/div/div[2]/table/tbody/tr[4]/td[7]/div").exists?
# 	@browser.input(:xpath,"//div[6]/div[2]/div[1]/div/div/div/div/div/div[2]/table/tbody/tr[4]/td[7]/div").click
# end

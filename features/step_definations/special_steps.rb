Given /^I select lucky in love tour$/ do
	visit Booking
	on Special do |page|
		page.lucky
end
...
Given /^I select romantic tour$/ do
	visit Booking
	on Special do |page|
		page.romantic
end
...
Given /^I select vegas locals tour$/ do
	visit Booking
	on Special do |page|
		page.vegas
end
...
Given /^I select superhero tour$/ do
	visit Booking
	on Special do |page|
		page.superhero
end
...
Given /^I select fourth of july tour$/ do
	visit Booking
	on Special do |page|
		page.fourth
end
...
Given /^I select new year tour$/ do
	visit Booking
	on Special do |page|
		page.newyear
end
